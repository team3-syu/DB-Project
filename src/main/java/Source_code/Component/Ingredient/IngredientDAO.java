...
public class IngredientDAO {
    ...
    public IngredientDTO getIngredientByCode(SqlSession sqlSession, String component) {
        return sqlSession.selectOne("IngredientMapper.getIngredientByCode", component);
    }
